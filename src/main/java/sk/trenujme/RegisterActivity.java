...
import sk.trenujme.config.AppConfig;
import sk.trenujme.helper.SQLiteHandler;
import sk.trenujme.helper.SessionManager;
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        db.addUser(name, surname, email, token, created_at);
