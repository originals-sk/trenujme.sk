package sk.trenujme.helper;

/**
 * Created by René on 4.11.2016.
 */
...
public class SQLiteHandler extends SQLiteOpenHelper {
    ...
    // Database Name
    private static final String DATABASE_NAME = "trenujme_api";
    ...
    private static final String KEY_SURNAME = "last_name";
    ...
    public HashMap<String, String> getUserDetails() {
        ...
        if (cursor.getCount() > 0) {
            ...
            user.put("created", cursor.getString(5));
        }
        cursor.close();
        db.close();
        // return user
